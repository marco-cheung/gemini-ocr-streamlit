...
if uploaded_file1 is not None:
    ...
    "payment_total": number,   // Final amount paid by customer, say, net paid amount after deducting promotional offer such as gift card and e-Coupon discount. Decimal or null.
