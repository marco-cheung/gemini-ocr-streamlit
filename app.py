...
if uploaded_file1 is not None:
    ...
    6. remarks: If shop_name/order_datetime/payment_total is null, add: "{field name} cannot be auto-detected. Please upload a clear invoice image for verification."
