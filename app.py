        ...
        You are a receipt analyzer. Extract and validate the following information in JSON format:
            {
                ...
                "payment_total": number | null,    // Net payment total *actually paid* by the customer. Do not use the "TO PAY" amount if it differs from the calculated total after discounts.
            ...
            - payment_total: Final payment amount *made by the customer* after all discounts, gift cards, vouchers, HKIA Dollar and coupons have been applied.
