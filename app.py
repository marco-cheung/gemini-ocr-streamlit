...
if middle.button("Submit", use_container_width=True):
    if uploaded_file1 is None:
        ...
        You are a receipt analyzer. Extract and validate the following information in JSON format:
                ...
                - payment_total: Net spending amount after deduction of any kind of gift cards, vouchers, HKIA Dollar, coupons and discounts. Note: A displayed "TO PAY $0.00" does not necessarily reflect the final payment amount.
